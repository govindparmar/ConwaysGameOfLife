...
)
{
	...
	hWnd = CreateWindowExW(WS_EX_OVERLAPPEDWINDOW, g_wszClassName, APP_TITLE, WS_VISIBLE | WS_SYSMENU, 100, 100, GRIDSIZE * CELLSIZE + CELLSIZE, GRIDSIZE * CELLSIZE + CELLSIZE, NULL, NULL, hInstance, NULL);
	if (hWnd == NULL) 
	{
